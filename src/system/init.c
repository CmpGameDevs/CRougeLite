...
static void initPlayerWeaponDictionary()
{
  ...
  dict[0].entry.weapon = (Weapon){
      ...
      .weapon.ranged = {
          ...
          .bulletInfo = {4, 10, 600, 10, .bulletSprite = {}, .collider = {(Vector2){0, 0}, 32, 32}, .isTracking = true},
          30,
          30,
          1}};
  ...
  dict[1].entry.weapon = (Weapon){
      ...
      .weapon.ranged = {
          ...
          .bulletInfo = {4, 10, 1000, 10, .bulletSprite = {}, .collider = {(Vector2){0, 0}, 16, 16}, .isTracking = true},
          30,
          30,
          4}};
